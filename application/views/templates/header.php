<header class="main-header">
    ...
    <a href="<?= base_url() . 'interno/main' ?>" class="logo">
        ...
        <div class="pull-left image">
            <img src="<?= base_url() . 'img/logo_starperu.png'; ?>" class="img-responsive" alt="STARPERU">
        </div>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= base_url() . 'img/dev.png' ?>" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?= $this->session->nombre . ' ' . $this->session->apellido ?> </span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?= base_url() . 'img/dev.png' ?>" class="img-circle" alt="User Image">

                            <p>
                                <?= explode(' ', $this->session->nombre)[0] . ' ' . explode(' ', $this->session->apellido)[0] ?> - <?= $this->session->cargo ?>
