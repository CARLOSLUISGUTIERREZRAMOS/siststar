    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel"><strong>AGREGAR USUARIOS</strong></h4>
            </div>
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form-horizontal');
                echo form_open('agencias/Agencias/AgregarUsuario', $attributes)
                ?>
                <input type="hidden" id="codigoEntidad2" name="codigoEntidad2">
                <div class="form-group row">
                    <label for="dni" class="col-sm-2 col-form-label">DNI</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="dni" name="dni" required=""  onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="8">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="celular" maxlength="9" name="celular"  required onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                    </div>
                </div>
                <div class="form-group row">
