...
class Formulario_model extends CI_Model {
    ...
    function obtener_formularios($grupo,$id_usuario) {
        ...
        $res_grupos = $this->db->get_where('usuario_has_formulario_grupo u_fg', array('u_fg.id_usuario' => $id_usuario, 'g.id_grupo' => $grupo, 'f.estado' =>'Y' , 'fg.estado' => 'Y' , 'u.estado' => 'Y' , 'u.intentos <' => 3 ));
